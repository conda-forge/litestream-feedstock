...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/litestream-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/litestream-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install litestream
```
...
It is possible to list all of the versions of `litestream` available on your platform:
...
```
pixi search litestream --channel conda-forge
```
